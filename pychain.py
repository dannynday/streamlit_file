...
input_area_sender = st.text_input("sender")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
input_area_receiver = st.text_input("receiver")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
input_area_amount = st.text_input("amount")
...
if st.button("Add Block"):
    ...
    new_block = Block(
        #data=input_data,
        record= Record(input_area_sender,input_area_receiver,input_area_sender),
        creator_id=42,
